...
path_dfs = ''
dfProcessed.to_pickle(datapath+path_dfs+ db_name_table+'Processed3.pkl')
...
path_dicts = ''
with open(datapath+path_dicts+'distFreq'+db_name_table+'3.pkl', 'wb') as f:
...
path_graphs = ''  
nx.write_gexf(Gu, datapath+path_graphs+db_name_table+'NetworkGraph3.gexf')
    
with open(datapath+path_graphs+db_name_table+'Net3.cnf', 'wb') as handle:
