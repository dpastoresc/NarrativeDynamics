...
path_graphs='People/'
with open(datapath+path_graphs+db_name_table+'NetPeople'+tagfile+filtertag+'_c.cnf', 'rb') as handle:
    Gu=pickle.load(handle)   

with open(datapath+path_graphs+db_name_table+'NetDPeople'+tagfile+filtertag+'_c.cnf', 'rb') as handle:
...
with open(datapath+path_graphs+db_name_table+'PeopleDescriptors'+tagfile+filtertag+'_c.cnf', 'wb') as handle:
